 ...
 * @author Lari
 */
public class EstoqueMaterial extends javax.swing.JInternalFrame {
    ...
    public void readJTableForDesc(String desc) {
        ...
        for (Estoque e : edao.readForDesc(desc)) {
    ...
    private void btnCadastrarItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarItemActionPerformed
        ...
        e.setNome_material(txtItem.getText());
        e.setEstoque_atual(Integer.parseInt(txtQuantidade.getText()));
        dao.create(e);
    ...
    private void btnExcluirItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirItemActionPerformed
        if (tabelaEstoque.getSelectedRow() != -1) {
            ...
            e.setId_material((int) tabelaEstoque.getValueAt(tabelaEstoque.getSelectedRow(), 0));
...
public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstoqueMaterial().setVisible(true);
            }
        });
    }
